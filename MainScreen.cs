...
namespace GeneticAlgorithmTest
{
    public partial class MainScreen : Form
    {
        ...
        {
            infiniteMonkeyPage.Location = defUserControlLocation;
            mainPage.Location = defUserControlLocation;
        }
        ...
        {
            refreshSelectPanel(button2.Location.Y);
            infiniteMonkeyPage.BringToFront();
        }

        private void ınfiniteMonkeyPage1_Load(object sender, EventArgs e)
        {
